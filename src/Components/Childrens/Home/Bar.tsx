...
export default function Bar() {
  ...
  return (
    <div className="flex  bg-[#fff] shadow-md  rounded-lg
       lg:flex-row flex-wrap mb-10 lg:mb-2   max-md:justify-center
      gap-8 lg:justify-between items-center w-[100%] min-h-[400px] m-auto ">
      {data.map((el, index) => {
        return (
